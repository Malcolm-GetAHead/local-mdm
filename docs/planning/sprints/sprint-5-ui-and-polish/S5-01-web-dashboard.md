...
> **Note**: This task has been moved to Sprint 5d. See [Sprint 5d OVERVIEW](../sprint-5d-web-dashboard/OVERVIEW.md) for the full plan. Technology changed from React to HTMX + Go templates (decision 2026-04-20) — simpler stack, no separate build pipeline, same repo and deploy artifact.
