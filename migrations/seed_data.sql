...
INSERT INTO devices (id, enterprise_id, platform, device_id, serial_number, name, model, os_version, status, last_seen, platform_data) VALUES
  ...
  ('d0000000-0000-0000-0000-000000000030', '00000000-0000-0000-0000-000000000001', 'windows', 'win-030', 'BULK001', 'Accounting PC 1', 'Dell OptiPlex 7010', '10.0.22631', 'enrolled', NOW() - interval '1 hour', '{}'),
  ('d0000000-0000-0000-0000-000000000031', '00000000-0000-0000-0000-000000000001', 'windows', 'win-031', 'BULK002', 'Accounting PC 2', 'Dell OptiPlex 7010', '10.0.22631', 'enrolled', NOW() - interval '2 hours', '{}'),
  ('d0000000-0000-0000-0000-000000000032', '00000000-0000-0000-0000-000000000001', 'windows', 'win-032', 'BULK003', 'Accounting PC 3', 'Dell OptiPlex 7010', '10.0.22631', 'enrolled', NOW() - interval '3 hours', '{}'),
  ('d0000000-0000-0000-0000-000000000033', '00000000-0000-0000-0000-000000000001', 'macos', 'mac-033', 'BULK004', 'Design Mac 1', 'iMac 24"', '14.4.1', 'enrolled', NOW() - interval '4 hours', '{}'),
  ('d0000000-0000-0000-0000-000000000034', '00000000-0000-0000-0000-000000000001', 'macos', 'mac-034', 'BULK005', 'Design Mac 2', 'iMac 24"', '14.4.1', 'enrolled', NOW() - interval '5 hours', '{}'),
  ('d0000000-0000-0000-0000-000000000035', '00000000-0000-0000-0000-000000000001', 'windows', 'win-035', 'BULK006', 'Support PC 1', 'HP ProDesk 400', '10.0.22631', 'enrolled', NOW() - interval '6 hours', '{}'),
  ('d0000000-0000-0000-0000-000000000036', '00000000-0000-0000-0000-000000000001', 'windows', 'win-036', 'BULK007', 'Support PC 2', 'HP ProDesk 400', '10.0.22631', 'enrolled', NOW() - interval '7 hours', '{}'),
  ('d0000000-0000-0000-0000-000000000037', '00000000-0000-0000-0000-000000000001', 'windows', 'win-037', 'BULK008', 'Support PC 3', 'HP ProDesk 400', '10.0.22631', 'enrolled', NOW() - interval '8 hours', '{}'),
  ('d0000000-0000-0000-0000-000000000038', '00000000-0000-0000-0000-000000000001', 'android', 'and-038', 'BULK009', 'Warehouse Phone 1', 'Samsung Galaxy A14', '13', 'enrolled', NOW() - interval '9 hours', '{}'),
  ('d0000000-0000-0000-0000-000000000039', '00000000-0000-0000-0000-000000000001', 'android', 'and-039', 'BULK010', 'Warehouse Phone 2', 'Samsung Galaxy A14', '13', 'enrolled', NOW() - interval '10 hours', '{}'),
  ('d0000000-0000-0000-0000-000000000040', '00000000-0000-0000-0000-000000000001', 'windows', 'win-040', 'BULK011', 'Training Room PC 1', 'Dell Latitude 3540', '10.0.22631', 'enrolled', NOW() - interval '11 hours', '{}'),
  ('d0000000-0000-0000-0000-000000000041', '00000000-0000-0000-0000-000000000001', 'windows', 'win-041', 'BULK012', 'Training Room PC 2', 'Dell Latitude 3540', '10.0.22631', 'enrolled', NOW() - interval '12 hours', '{}'),
  ('d0000000-0000-0000-0000-000000000042', '00000000-0000-0000-0000-000000000001', 'windows', 'win-042', 'BULK013', 'Training Room PC 3', 'Dell Latitude 3540', '10.0.22631', 'enrolled', NOW() - interval '13 hours', '{}'),
  ('d0000000-0000-0000-0000-000000000043', '00000000-0000-0000-0000-000000000001', 'macos', 'mac-043', 'BULK014', 'Marketing Mac 1', 'MacBook Air M2', '14.3', 'enrolled', NOW() - interval '14 hours', '{}'),
  ('d0000000-0000-0000-0000-000000000044', '00000000-0000-0000-0000-000000000001', 'macos', 'mac-044', 'BULK015', 'Marketing Mac 2', 'MacBook Air M2', '14.3', 'enrolled', NOW() - interval '15 hours', '{}'),
  ('d0000000-0000-0000-0000-000000000045', '00000000-0000-0000-0000-000000000001', 'windows', 'win-045', 'BULK016', 'Reception PC', 'HP EliteDesk 800', '10.0.22631', 'enrolled', NOW() - interval '16 hours', '{}'),
  ('d0000000-0000-0000-0000-000000000046', '00000000-0000-0000-0000-000000000001', 'windows', 'win-046', 'BULK017', 'Server Room KVM', 'Dell OptiPlex 3000', '10.0.22631', 'enrolled', NOW() - interval '17 hours', '{}'),
  ('d0000000-0000-0000-0000-000000000047', '00000000-0000-0000-0000-000000000001', 'android', 'and-047', 'BULK018', 'Delivery Phone 1', 'Google Pixel 7a', '14', 'enrolled', NOW() - interval '18 hours', '{}'),
  ('d0000000-0000-0000-0000-000000000048', '00000000-0000-0000-0000-000000000001', 'android', 'and-048', 'BULK019', 'Delivery Phone 2', 'Google Pixel 7a', '14', 'enrolled', NOW() - interval '19 hours', '{}'),
  ('d0000000-0000-0000-0000-000000000049', '00000000-0000-0000-0000-000000000001', 'android', 'and-049', 'BULK020', 'Delivery Phone 3', 'Google Pixel 7a', '14', 'enrolled', NOW() - interval '20 hours', '{}'),
  ('d0000000-0000-0000-0000-000000000050', '00000000-0000-0000-0000-000000000001', 'windows', 'win-050', 'BULK021', 'Lab PC 1', 'HP ZBook Fury', '10.0.22631', 'enrolled', NOW() - interval '21 hours', '{}'),
  ('d0000000-0000-0000-0000-000000000051', '00000000-0000-0000-0000-000000000001', 'windows', 'win-051', 'BULK022', 'Lab PC 2', 'HP ZBook Fury', '10.0.22631', 'enrolled', NOW() - interval '22 hours', '{}'),
  ('d0000000-0000-0000-0000-000000000052', '00000000-0000-0000-0000-000000000001', 'macos', 'mac-052', 'BULK023', 'QA Mac 1', 'Mac Mini M2', '14.4', 'enrolled', NOW() - interval '23 hours', '{}'),
  ('d0000000-0000-0000-0000-000000000053', '00000000-0000-0000-0000-000000000001', 'macos', 'mac-053', 'BULK024', 'QA Mac 2', 'Mac Mini M2', '14.4', 'enrolled', NOW() - interval '24 hours', '{}'),
  ('d0000000-0000-0000-0000-000000000054', '00000000-0000-0000-0000-000000000001', 'windows', 'win-054', 'BULK025', 'Intern Laptop 1', 'Dell Latitude 3540', '10.0.22631', 'enrolled', NOW() - interval '25 hours', '{}'),
  ('d0000000-0000-0000-0000-000000000055', '00000000-0000-0000-0000-000000000001', 'windows', 'win-055', 'BULK026', 'Intern Laptop 2', 'Dell Latitude 3540', '10.0.22631', 'enrolled', NOW() - interval '26 hours', '{}'),
  ('d0000000-0000-0000-0000-000000000056', '00000000-0000-0000-0000-000000000001', 'android', 'and-056', 'BULK027', 'Security Phone 1', 'Samsung Galaxy XCover6', '13', 'enrolled', NOW() - interval '27 hours', '{}'),
  ('d0000000-0000-0000-0000-000000000057', '00000000-0000-0000-0000-000000000001', 'android', 'and-057', 'BULK028', 'Security Phone 2', 'Samsung Galaxy XCover6', '13', 'enrolled', NOW() - interval '28 hours', '{}'),
  ('d0000000-0000-0000-0000-000000000058', '00000000-0000-0000-0000-000000000001', 'macos', 'mac-058', 'BULK029', 'Remote Mac 1', 'MacBook Pro 14"', '14.4', 'enrolled', NOW() - interval '29 hours', '{}'),
  ('d0000000-0000-0000-0000-000000000059', '00000000-0000-0000-0000-000000000001', 'macos', 'mac-059', 'BULK030', 'Remote Mac 2', 'MacBook Pro 14"', '14.4', 'enrolled', NOW() - interval '30 hours', '{}')
